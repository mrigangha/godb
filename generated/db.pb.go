...
var file_proto_db_proto_goTypes = []any{
	...
	(*DeleteRequest)(nil),  // 4: db.DeleteRequest
	(*DeleteResponse)(nil), // 5: db.DeleteResponse
}
var file_proto_db_proto_depIdxs = []int32{
	0, // 0: db.NoSQLDB.Set:input_type -> db.SetRequest
	2, // 1: db.NoSQLDB.Get:input_type -> db.GetRequest
	4, // 2: db.NoSQLDB.Delete:input_type -> db.DeleteRequest
	1, // 3: db.NoSQLDB.Set:output_type -> db.SetResponse
	3, // 4: db.NoSQLDB.Get:output_type -> db.GetResponse
	5, // 5: db.NoSQLDB.Delete:output_type -> db.DeleteResponse
